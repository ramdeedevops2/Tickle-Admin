...
export default function SetupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md relative z-10 border border-border/50 shadow-2xl">
        <CardHeader className="space-y-1 pb-8">
          ...
          <CardDescription className="text-muted-foreground">
            You are setting up the first administrative account for TICKLE.
          </CardDescription>
        </CardHeader>
          ...
          <form onSubmit={handleSetup} className="space-y-6">
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                className="bg-transparent border border-border focus-visible:ring-1 focus-visible:ring-primary rounded-none"
              />
            </div>
            ...
            <div className="bg-muted/30 p-4 rounded-lg border border-border/50 space-y-2">
              <p className="text-xs text-muted-foreground leading-relaxed">
                By completing this setup, your account will be granted{" "}
                <span className="text-primary font-medium">Full Access</span>.
                You will be responsible for inviting other team members and
