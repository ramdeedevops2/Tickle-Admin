...
export const COMMANDS: CommandEntry[] = [
  ...
  },
  {
    ...
    keywords: ["pack", "price", "promo", "premium", "trial", "offer", "bonus", "purchase", "hearts", "roses"],
    kind: "page",
    icon: Coins,
    href: "/economy",
    group: "Pages",
  ...
  },
  {
    id: "page:config",
    title: "Config",
    subtitle: "App-wide settings",
    keywords: ["settings", "options", "tuning"],
    kind: "page",
    icon: Settings,
    href: "/config",
    group: "Pages",
  ...
  },
  {
    ...
    kind: "setting",
    icon: Ban,
    href: "/config#blocked-categories",
    group: "Config",
  },
  {
...

  {
    ...
    kind: "setting",
    icon: Ban,
    href: "/config#free-daily-interactions",
    group: "Config",
  },
  {
    ...
    kind: "setting",
    icon: Ban,
    href: "/config#free-daily-comments",
    group: "Config",
  },
  {
    ...
    kind: "setting",
    icon: Sparkles,
    href: "/config#free-daily-super-likes",
    group: "Config",
  },
  {
    ...
    kind: "setting",
    icon: Radius,
    href: "/config#premium-visibility-multiplier",
    group: "Config",
  },
